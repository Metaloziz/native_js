...
// 	},
// 	perimeter: () => 4 * this.side // будет ссылаться на window
// };
//
...
// "Дана задача, что произойдет при вызове функции:
...
//Task 2
// console.log('Start');
// Promise.resolve('mere').then(console.log);
// console.log('End');
...
// window.location отвечает за браузерную строку
...
// 	day: 'numeric'
// };
// let formattedDate = date.toLocaleDateString('de', dateDusplayOptions);
...
// class Task {
// 	constructor() {
// 		console.log(new.target.name); // new
// 	}
// }
